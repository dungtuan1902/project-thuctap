                ...
                @foreach ($book as $item)
                    <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                        <a class="product-item" href="{{ route('detail', ['id' => $item->id]) }}">
                            <img src="{{ Storage::url($item->image) }}" style="height: 300px ; width: auto;"
    ...
    <div class="why-choose-section">
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-5">
                    <div class="img-wrap">
                        <img src="{{ asset('assets/img/bfeb4898fd66d22e9741cb9830032a4f.jpg') }}" alt="Image"
                            class="img-fluid">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="imgs-grid">
                        <div class="grid grid-1"><img src="{{ asset('assets\img\5-tren-giay-729x1024.jpg') }}"
                                alt="Untree.co">
                        </div>
                        <div class="grid grid-2"><img src="{{ asset('assets\img\5.jpg') }}" alt="Untree.co">
                        </div>
                        <div class="grid grid-3"><img
                                src="{{ asset('assets\img\bia-sach-dep-ngoi-nha-nghin-hanh-lang.jpg') }}" alt="Untree.co">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="testimonial-slider-wrap text-center">
                        ...
                        <div id="testimonial-nav">
                            <span class="prev" data-controls="prev"><span class="fa fa-chevron-left"><svg
                            ...
                            <span class="next" data-controls="next"><span class="fa fa-chevron-right"><svg
                                        xmlns="http://www.w3.org/2000/svg" height="1.25em"
                                        viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        <path
                                    ...
                                    <div class="col-lg-8 mx-auto">
                                        ...
                                        <div class="testimonial-block text-center">
                                            <blockquote class="mb-5">
                                                <p>&ldquo;We also learn about the various types of plants and birds that
                                                    exist throughout the world. The plants and birds in the cold lands are
                                                    not the same as those in warmer lands. In the same way, the land forms
                                                    in the cold regions are different from those in other regions. In the
                                                    equatorial regions, for example, plant and animal life is luxuriant
                                                    while in the poles the land is covered with snow, and animal and plant
                                                    life is less abundant. In equatorial regions abundant rain has produced
                                                    large rivers and lakes, while in areas where little rain falls there are
                                                    large deserts without many rivers and lakes.&rdquo;</p>
                                            </blockquote>
                                            ...
                                            <div class="author-info">
                                                ...
                                                <h3 class="font-weight-bold">Pham Tuan Dung</h3>
                            ...
                            <div class="item">
                                <div class="row justify-content-center">
                                    <div class="col-lg-8 mx-auto">
                                        ...
                                        <div class="testimonial-block text-center">
                                            <blockquote class="mb-5">
                                                <p>&ldquo;Until the rutrum nibh that purus is made ultricies. Sing in the
                                                    Department
                                                    What do you expect from the players? There were no trucks. A certain
                                                    vulputate
                                                    In mourning, he wants to invest in real estate. &rdquo;</p>
                                            </blockquote>
                                            ...
                                            <h3 class="font-weight-bold">Doan Huu Quy</h3>
                                                <span class="position d-block mb-3">CEO, Co-Founder, XYZ Inc.</span>
                                            </div>
                                        </div>
